    ...
    <footer className="bg-slate-950 text-white pt-14 pb-8 mt-16">
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid gap-10 md:grid-cols-3">
          <div>
            <h3 className="text-xl font-bold text-orange-400">NT Puja</h3>
            <p className="text-gray-400 mt-3 leading-relaxed">
              Traditional rituals, verified acharyas, and complete support for
              your puja and jyotish needs across India.
            </p>
            <a
              href="https://wa.me/918601079823?text=Hello%20Nerds%20Travel%2C%20I%20want%20to%20book%20a%20puja."
              target="_blank"
              rel="noreferrer"
          ...
          <div>
            <h4 className="text-lg font-semibold mb-4">Top Pujas</h4>
        ...
        <div className="mt-10 pt-6 border-t border-white/10 text-xs text-gray-500 flex flex-col sm:flex-row justify-between gap-3">
          <span>© {new Date().getFullYear()} Puja. All rights reserved.</span>
